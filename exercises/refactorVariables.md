...
This is a good candidate for OOP. When you have a bunch of declared variables at the top of a function, they may as well be keys. As is, these variables are in and out of multiple code blocks and it is not handled elegantly. 
